    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('PageID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mainapp.Pages')),
            ],
        ),
        migrations.CreateModel(
            name='Persons',
        ...
        migrations.AddField(
            ...
            name='PersonID',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mainapp.Persons', verbose_name='Идентификатор личности'),
        ),
        migrations.AddField(
            model_name='pages',
            name='SiteID',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mainapp.Sites'),
        ),
        migrations.AddField(
            model_name='keywords',
            name='PersonID',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mainapp.Persons'),
        ),
    ]
